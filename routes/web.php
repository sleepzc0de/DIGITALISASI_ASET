...
use App\Http\Controllers\Admin\ImportAsetController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['admin', 'super_admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        // ── Import Aset ─────────────────────────────────────────
        // WAJIB didefinisikan SEBELUM Route::resource('dashboard-aset')
        // agar URL /admin/dashboard-aset/import tidak ditangkap sebagai
        // wildcard {dashboardAset} milik route resource show/edit.
        Route::get('dashboard-aset/import',
            [ImportAsetController::class, 'create'])
            ->name('dashboard-aset.import.create');

        Route::post('dashboard-aset/import',
            [ImportAsetController::class, 'store'])
            ->name('dashboard-aset.import.store');

        Route::get('dashboard-aset/import/template',
            [ImportAsetController::class, 'downloadTemplate'])
            ->name('dashboard-aset.import.template');
