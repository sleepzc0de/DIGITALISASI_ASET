<nav x-data="{ open: false, dropdownOpen: false }" class="sticky top-0 z-30 bg-white/90 backdrop-blur-md shadow-lg shadow-blue-100/50 border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden md:flex items-center space-x-1 ml-10">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="group">
                        <div class="flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 hover:bg-blue-50 hover:text-blue-600 {{ request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-600' : 'text-gray-700' }}">
                    ...
                    <x-nav-link :href="route('kinerja')" :active="request()->routeIs('kinerja')" class="group">
                        <div class="flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 hover:bg-green-50 hover:text-green-600 {{ request()->routeIs('kinerja') ? 'bg-green-50 text-green-600' : 'text-gray-700' }}">
                    ...
                    @if(auth()->user()->isAdmin())
                        <div class="relative" x-data="{ adminOpen: false }" @mouseenter="adminOpen = true" @mouseleave="adminOpen = false">
                            <button class="flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 hover:bg-purple-50 text-gray-700">
                                <i class="fas fa-cog text-lg"></i>
                                <span class="font-medium">{{ __('Administrator') }}</span>
                                <i class="fas fa-chevron-down text-xs transition-transform duration-200" :class="{ 'rotate-180': adminOpen }"></i>
                            </button>
                            ...
                            <div x-show="adminOpen" x-transition:enter="transition ease-out duration-200"
                                ...
                                <a href="{{ route('admin.dashboard-aset.index') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-50 text-gray-700">
                                ...
                                <a href="{{ route('admin.kinerja-bmn.index') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-50 text-gray-700">
            ...
            <div class="hidden md:flex items-center space-x-4">
                <!-- Notification Bell -->
                <button class="relative h-10 w-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
                ...
                <div class="relative" x-data="{ userOpen: false }" @click.outside="userOpen = false">
                    <button @click="userOpen = !userOpen" class="flex items-center space-x-3 group">
                        ...
                        <i class="fas fa-chevron-down text-gray-400 text-sm transition-transform duration-200" :class="{ 'rotate-180': userOpen }"></i>
                    </button>
                    ...
                    <div x-show="userOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        <a href="{{ route('profile.edit') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-50 text-gray-700">
                            <div class="h-8 w-8 rounded-lg bg-blue-100 flex items-center justify-center">
                        ...
                        <div class="border-t border-gray-100 mt-2 pt-2">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="flex items-center space-x-3 px-4 py-3 hover:bg-red-50 text-red-600 w-full">
            ...
            <div class="md:hidden flex items-center">
                <button @click="open = !open" class="h-10 w-10 rounded-lg bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="px-4 py-3 space-y-1">
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-3 py-3 rounded-lg hover:bg-blue-50 text-gray-700">
            ...
            <a href="{{ route('kinerja') }}" class="flex items-center space-x-3 px-3 py-3 rounded-lg hover:bg-green-50 text-gray-700">
            ...
            @if(auth()->user()->isAdmin())
                <div class="border-t border-gray-100 pt-3 mt-3">
                    ...
                    <a href="{{ route('admin.dashboard-aset.index') }}" class="flex items-center space-x-3 px-3 py-3 rounded-lg hover:bg-purple-50 text-gray-700">
                    ...
                    <a href="{{ route('admin.kinerja-bmn.index') }}" class="flex items-center space-x-3 px-3 py-3 rounded-lg hover:bg-purple-50 text-gray-700">
                        <div class="h-10 w-10 rounded-lg bg-purple-100 flex items-center justify-center">
        ...
        <div class="border-t border-gray-100 px-4 py-4 bg-gray-50">
            ...
            <div class="space-y-2">
                <a href="{{ route('profile.edit') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-white text-gray-700">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-red-50 text-red-600 w-full">
                        <i class="fas fa-sign-out-alt"></i>
                        <span>Keluar</span>
                    </button>
                </form>
