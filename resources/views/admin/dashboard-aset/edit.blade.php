<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">{{ __('Edit Data Aset') }}</h2>
                <p class="mt-1 text-sm text-gray-600">
                    Edit aset: <strong>{{ $dashboardAset->kategori_aset }}</strong>
                </p>
                <p class="text-xs text-gray-500 mt-1">
                    ID: ASET{{ str_pad($dashboardAset->id, 4, '0', STR_PAD_LEFT) }}
                    &bull; Diupdate: {{ $dashboardAset->updated_at->format('d/m/Y H:i') }}
                </p>
            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="kategori_aset" name="kategori_aset"
                                       value="{{ old('kategori_aset', $dashboardAset->kategori_aset) }}"
                                ...
                                <datalist id="kategori-suggestions">
                                    <option value="Kendaraan"><option value="Elektronik">
                                    <option value="Furniture"><option value="Bangunan">
                                    <option value="Tanah"><option value="Peralatan Kantor">
                                    <option value="Mesin">
                                </datalist>
                            </div>
                            @error('kategori_aset')
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="jumlah_unit" name="jumlah_unit"
                                       value="{{ old('jumlah_unit', $dashboardAset->jumlah_unit) }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="nilai_perolehan" name="nilai_perolehan"
                                       value="{{ old('nilai_perolehan', $dashboardAset->nilai_perolehan) }}"
                        ...
                        <div class="space-y-1.5">
                            <label for="nilai_buku" class="block text-sm font-medium text-gray-700">
                                <i class="fas fa-file-invoice-dollar text-blue-500 mr-1.5"
                                   aria-hidden="true"></i>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="nilai_buku" name="nilai_buku"
                                       value="{{ old('nilai_buku', $dashboardAset->nilai_buku) }}"
                                       required min="0" max="999999999999"
                                       class="input-field pl-12
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <select id="kondisi" name="kondisi" required
                                    ...
                                    @foreach($kondisiList as $k)
                                        <option value="{{ $k }}"
                                            {{ old('kondisi', $dashboardAset->kondisi) === $k
                                               ? 'selected' : '' }}>
                                            {{ $k }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="flex gap-2 mt-1">
                                <span class="px-2 py-0.5 bg-green-100 text-green-800
                                             rounded text-xs">Baik</span>
                                <span class="px-2 py-0.5 bg-yellow-100 text-yellow-800
                                             rounded text-xs">Rusak Ringan</span>
                                <span class="px-2 py-0.5 bg-red-100 text-red-800
                                             rounded text-xs">Rusak Berat</span>
                            </div>
                            @error('kondisi')
                            <p class="text-sm text-red-600 flex items-center gap-1" role="alert">
                                <i class="fas fa-exclamation-circle" aria-hidden="true"></i>{{ $message }}
                        ...
                        <div class="space-y-1.5">
                            <label for="lokasi" class="block text-sm font-medium text-gray-700">
                                <i class="fas fa-map-marker-alt text-blue-500 mr-1.5"
                                   aria-hidden="true"></i>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="lokasi" name="lokasi"
                                       value="{{ old('lokasi', $dashboardAset->lokasi) }}"
                        ...
                        <div class="space-y-1.5">
                            <label for="tahun" class="block text-sm font-medium text-gray-700">
                                <i class="fas fa-calendar-alt text-blue-500 mr-1.5"
                                   aria-hidden="true"></i>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="tahun" name="tahun"
                                       value="{{ old('tahun', $dashboardAset->tahun) }}"
                        ...
                        <div class="md:col-span-2 space-y-1.5">
                            <label for="keterangan" class="block text-sm font-medium text-gray-700">
                                <i class="fas fa-sticky-note text-blue-500 mr-1.5"
                                   aria-hidden="true"></i>
                                Keterangan
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    <div class="flex items-start gap-3">
                        <div class="h-8 w-8 rounded-full bg-purple-100 flex items-center
                                    justify-center flex-shrink-0">
                            <i class="fas fa-lightbulb text-purple-600 text-sm"
                               aria-hidden="true"></i>
                        </div>
                        <div>
