    ...
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mb-3">
            <ol class="flex items-center gap-1.5 text-xs text-gray-500">
                ...
                <li aria-hidden="true">
                    <i class="fas fa-chevron-right text-[9px] text-gray-300" aria-hidden="true"></i>
                </li>
                <li>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 mb-6">
                <form method="GET" action="{{ route('admin.dashboard-aset.index') }}"
                    ...
                    {{-- Filter Kondisi --}}
                    <select name="kondisi" onchange="this.form.submit()" aria-label="Filter berdasarkan kondisi"
                    ...
                    {{-- Sort --}}
                    <select name="sort" onchange="this.form.submit()" aria-label="Urutkan berdasarkan"
                        class="px-3 py-2 text-sm border border-gray-300 rounded-lg
                                   focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white">
                    ...
                    {{-- Arah sort --}}
                    <select name="dir" onchange="this.form.submit()" aria-label="Arah urutan"
                        class="px-3 py-2 text-sm border border-gray-300 rounded-lg
                                   focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white">
                    ...
                    <div class="ml-auto text-sm text-gray-500">
                        Menampilkan
                        <span class="font-semibold text-gray-700">{{ $asets->firstItem() ?? 0 }}</span>–<span
                            class="font-semibold text-gray-700">{{ $asets->lastItem() ?? 0 }}</span>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <div
                                                ...
                                                <i class="fas {{ $icon }} text-blue-600"
                                                    aria-hidden="true"></i>
                                            </div>
                                            <div>
    ...
    <div id="deleteModal" role="dialog" aria-modal="true" aria-labelledby="deleteModalTitle"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md
            ...
            <div class="p-6 text-center">
                <div
                    class="mx-auto flex items-center justify-center h-14 w-14
                            rounded-full bg-red-100 mb-4">
                    <i class="fas fa-exclamation-triangle text-red-600 text-2xl" aria-hidden="true"></i>
                </div>
                <h3 id="deleteModalTitle" class="text-lg font-bold text-gray-900 mb-2">
                    Hapus Data Aset
                </h3>
                ...
                --}}
                <p id="deleteModalName" class="text-base font-semibold text-gray-900 mb-4">
                </p>
