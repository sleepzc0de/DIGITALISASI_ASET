<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                <form method="GET" action="{{ route('admin.dashboard-aset.index') }}" role="search" class="relative">
                    ...
                    <input id="headerSearch" type="search" name="search" value="{{ request('search') }}"
                ...
                <a href="{{ route('admin.dashboard-aset.import.create') }}"
                    class="inline-flex items-center gap-2 px-4 py-2.5
          bg-white border border-gray-300 hover:border-teal-400
          ...
          focus:ring-offset-2 whitespace-nowrap">
                    <i class="fas fa-file-import text-xs" aria-hidden="true"></i>
                    Import
                </a>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div
                    class="group relative bg-white rounded-2xl border border-gray-100
                            ...
                            overflow-hidden">
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-blue-50 to-transparent
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                    <i class="fas fa-layer-group text-blue-400" aria-hidden="true"></i>
                                    {{ $asets->lastPage() }} halaman data
                                </p>
                            </div>
                            <div
                                class="flex-shrink-0 h-12 w-12 rounded-2xl
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-emerald-50 to-transparent
                                opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                    <div class="relative p-5">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                    <i class="fas fa-calculator text-emerald-400" aria-hidden="true"></i>
                            ...
                            <div
                                class="flex-shrink-0 h-12 w-12 rounded-2xl
                                        ...
                                        group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-money-bill-wave text-white text-lg" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <div class="flex items-center justify-between text-xs">
                ...
                <div
                    class="group relative bg-white rounded-2xl border border-gray-100
                            shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-violet-50 to-transparent
                                opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                    <div class="relative p-5">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                    <i class="fas fa-map-marker-alt text-violet-400" aria-hidden="true"></i>
                            ...
                            <div
                                class="flex-shrink-0 h-12 w-12 rounded-2xl
                                        ...
                                        group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-layer-group text-white text-lg" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <div class="flex items-center justify-between text-xs">
                ...
                <div
                    class="group relative bg-white rounded-2xl border border-gray-100
                            shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-amber-50 to-transparent
                                opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                    <div class="relative p-5">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                    <i class="fas fa-exclamation-triangle text-amber-400" aria-hidden="true"></i>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            ...
                            @php
                                ...
                                $pctBaik = $totalAset > 0 ? round((($stats->total_baik ?? 0) / $totalAset) * 100) : 0;
                            @endphp
                            ...
                            <div class="w-full bg-gray-100 rounded-full h-1.5">
                                <div class="bg-gradient-to-r from-amber-400 to-amber-600
                                    ...
                                    style="width: {{ $pctBaik }}%" role="progressbar"
                                    aria-valuenow="{{ $pctBaik }}" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
                <div class="px-5 py-4">
                    <form method="GET" action="{{ route('admin.dashboard-aset.index') }}" id="filterForm"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select name="sort" onchange="document.getElementById('filterForm').submit()"
                                ...
                                <option value="created_at"
                                    {{ request('sort', 'created_at') === 'created_at' ? 'selected' : '' }}>Terbaru</option>
                                ...
                                <option value="jumlah_unit" {{ request('sort') === 'jumlah_unit' ? 'selected' : '' }}>
                                    Jumlah Unit</option>
                                <option value="tahun" {{ request('sort') === 'tahun' ? 'selected' : '' }}>Tahun
                                </option>
                            </select>
                        ...
                        <div class="ml-auto text-xs text-gray-400 whitespace-nowrap">
                            <span
                                class="font-semibold text-gray-700">{{ $asets->firstItem() ?? 0 }}–{{ $asets->lastItem() ?? 0 }}</span>
                            dari
                        ...
                        @if (request('search'))
                            <span
                                ...
                                <a href="{{ request()->fullUrlWithQuery(['search' => null, 'page' => 1]) }}"
                                    class="ml-0.5 hover:text-blue-900" aria-label="Hapus filter pencarian">
                                    <i class="fas fa-times text-[10px]" aria-hidden="true"></i>
                                </a>
                            </span>
                        @endif
                        @if (request('kondisi'))
                            <span
                                ...
                                <a href="{{ request()->fullUrlWithQuery(['kondisi' => null, 'page' => 1]) }}"
                                    class="ml-0.5 hover:text-blue-900" aria-label="Hapus filter kondisi">
                                    <i class="fas fa-times text-[10px]" aria-hidden="true"></i>
                                </a>
                            </span>
                        @endif
                    ...
                    <table class="min-w-full" role="table">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100">
                                ...
                                @endphp
                                @foreach ($cols as $col)
                                    <th scope="col" class="px-5 py-3.5 text-{{ $col['align'] }}">
                                ...
                                <tr class="group hover:bg-blue-50/30 transition-colors duration-150
                                    ...
                                    <td class="px-5 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="flex-shrink-0 h-10 w-10 rounded-xl
                                    ...
                                    <td class="px-5 py-4">
                                        <span
                                            ...
                                            <span
                                                class="h-1.5 w-1.5 rounded-full {{ $kCfg['dot'] }}
                                                     animate-pulse-slow"
                                    ...
                                    <td class="px-5 py-4">
                                        ...
                                        <p
                                            class="text-xs mt-0.5 {{ $usiaTahun > 10 ? 'text-red-400' : ($usiaTahun > 5 ? 'text-yellow-500' : 'text-gray-400') }}">
                                            {{ $usiaTahun }} tahun
                                        </p>
                                    </td>
                                        ...
                                        <div
                                            ...
                                            <button data-id="{{ $aset->id }}"
                                                ...
                                                class="h-8 w-8 rounded-lg flex items-center justify-center
                                                   ...
                                                   transition-all duration-150"
                                                title="Hapus" aria-label="Hapus {{ $aset->kategori_aset }}">
                                ...
                                <tr>
                                    <td colspan="7" class="px-5 py-20 text-center">
                                        <div class="flex flex-col items-center justify-center gap-3">
                                            <div
                                                class="h-20 w-20 rounded-2xl bg-gray-100
                                                    flex items-center justify-center">
    ...
    <div id="deleteModal" role="dialog" aria-modal="true" aria-labelledby="deleteModalTitle"
        ...
        {{-- Overlay --}}
        <div class="absolute inset-0 bg-gray-900/50 backdrop-blur-sm" onclick="closeDeleteModal()"
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-center mb-5">
                        <div
                            class="h-16 w-16 rounded-2xl bg-red-50 border border-red-100
                                    flex items-center justify-center">
                            <i class="fas fa-trash-alt text-red-500 text-2xl" aria-hidden="true"></i>
                        </div>
                    </div>

                    {{-- Text --}}
                    <div class="text-center mb-6">
                        <h3 id="deleteModalTitle" class="text-lg font-bold text-gray-900 mb-1">
                            Hapus Data Aset?
                        </h3>
                        ...
                        <p
                            class="text-xs text-red-500 mt-3 flex items-center
                    ...
                    <div class="flex gap-3">
                        ...
                        <form id="deleteForm" method="POST" class="flex-1">
                            ...
                            <button type="submit"
                                ...
                                <i class="fas fa-trash-alt mr-1.5 text-xs" aria-hidden="true"></i>
                                Ya, Hapus
                            </button>
                        </form>
                    </div>
