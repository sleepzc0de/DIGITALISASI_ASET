<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">
            {{ __('Tambah Wasdal BMN') }}
        </h2>
    </x-slot>

    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.manajemen-bmn.wasdal.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenis_wasdal" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <option value="Pelaporan BMN" {{ old('jenis_wasdal') == 'Pelaporan BMN' ? 'selected' : '' }}>Pelaporan BMN</option>
                            <option value="Sensus BMN" {{ old('jenis_wasdal') == 'Sensus BMN' ? 'selected' : '' }}>Sensus BMN</option>
                        </select>
                        @error('jenis_wasdal')
                    ...
                    <div>
                        ...
                        <select name="periode" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <option value="Semester I" {{ old('periode') == 'Semester I' ? 'selected' : '' }}>Semester I</option>
                            <option value="Semester II" {{ old('periode') == 'Semester II' ? 'selected' : '' }}>Semester II</option>
                            <option value="Tahunan" {{ old('periode') == 'Tahunan' ? 'selected' : '' }}>Tahunan</option>
                            <option value="Insidental" {{ old('periode') == 'Insidental' ? 'selected' : '' }}>Insidental</option>
                        </select>
                        @error('periode')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_laporan" value="{{ old('tanggal_laporan') }}" required
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_mulai_pelaksanaan" value="{{ old('tanggal_mulai_pelaksanaan') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_selesai_pelaksanaan" value="{{ old('tanggal_selesai_pelaksanaan') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_aset_tercatat" value="{{ old('jumlah_aset_tercatat') }}" min="0"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_aset_terverifikasi" value="{{ old('jumlah_aset_terverifikasi') }}" min="0"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="total_nilai_buku" value="{{ old('total_nilai_buku') }}" min="0" step="0.01"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="aset_kondisi_baik" value="{{ old('aset_kondisi_baik') }}" min="0"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="aset_kondisi_rusak_ringan" value="{{ old('aset_kondisi_rusak_ringan') }}" min="0"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="aset_kondisi_rusak_berat" value="{{ old('aset_kondisi_rusak_berat') }}" min="0"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="petugas_pelaksana" value="{{ old('petugas_pelaksana') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="pejabat_penerima" value="{{ old('pejabat_penerima') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="temuan" rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('temuan') }}</textarea>
                        @error('temuan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="rekomendasi" rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('rekomendasi') }}</textarea>
                        @error('rekomendasi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="file" name="file_lampiran" accept=".pdf,.zip,.rar"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        <p class="mt-1 text-xs text-gray-500">Format: PDF, ZIP, RAR. Maksimal 10MB</p>
                        @error('file_lampiran')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
