<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">
            {{ __('Tambah Pemanfaatan BMN') }}
        </h2>
    </x-slot>

    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.manajemen-bmn.pemanfaatan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenis_pemanfaatan" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <option value="SK Sewa" {{ old('jenis_pemanfaatan') == 'SK Sewa' ? 'selected' : '' }}>SK Sewa</option>
                            <option value="Izin Penghunian" {{ old('jenis_pemanfaatan') == 'Izin Penghunian' ? 'selected' : '' }}>Izin Penghunian</option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama_pihak_ketiga" value="{{ old('nama_pihak_ketiga') }}" required
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat_objek" rows="2" required
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('alamat_objek') }}</textarea>
                        @error('alamat_objek')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="latitude" value="{{ old('latitude') }}" step="0.00000001" min="-90" max="90"
                    ...
                    <div>
                        ...
                        <input type="number" name="longitude" value="{{ old('longitude') }}" step="0.00000001" min="-180" max="180"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi_objek" rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('deskripsi_objek') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" name="luas_tanah" value="{{ old('luas_tanah') }}" min="0" step="0.01"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('luas_tanah')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="luas_bangunan" value="{{ old('luas_bangunan') }}" min="0" step="0.01"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('luas_bangunan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="nilai_sewa_tahunan" value="{{ old('nilai_sewa_tahunan') }}" min="0" step="0.01"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="masa_pemanfaatan_bulan" value="{{ old('masa_pemanfaatan_bulan') }}" min="1"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <option value="Diperpanjang" {{ old('status') == 'Diperpanjang' ? 'selected' : '' }}>Diperpanjang</option>
