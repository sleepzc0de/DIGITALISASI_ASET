<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">
            {{ __('Tambah Data Penatausahaan BMN') }}
        </h2>
    </x-slot>

    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.manajemen-bmn.penatausahaan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="kategori" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <option value="Gedung Bangunan" {{ old('kategori') == 'Gedung Bangunan' ? 'selected' : '' }}>Gedung Bangunan</option>
                            <option value="Rumah Negara" {{ old('kategori') == 'Rumah Negara' ? 'selected' : '' }}>Rumah Negara</option>
                            <option value="Kendaraan Dinas Operasional" {{ old('kategori') == 'Kendaraan Dinas Operasional' ? 'selected' : '' }}>Kendaraan Dinas Operasional</option>
                            <option value="Kendaraan Dinas Jabatan" {{ old('kategori') == 'Kendaraan Dinas Jabatan' ? 'selected' : '' }}>Kendaraan Dinas Jabatan</option>
                            <option value="Kendaraan Dinas Fungsional" {{ old('kategori') == 'Kendaraan Dinas Fungsional' ? 'selected' : '' }}>Kendaraan Dinas Fungsional</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="spesifikasi" rows="2"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('spesifikasi') }}</textarea>
                        @error('spesifikasi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_polisi" value="{{ old('nomor_polisi') }}" placeholder="Untuk kendaraan"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('nomor_polisi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="tahun_pembuatan" value="{{ old('tahun_pembuatan') }}" maxlength="4" placeholder="2024"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_unit" value="{{ old('jumlah_unit', 1) }}" required min="1"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('jumlah_unit')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="satuan" value="{{ old('satuan') }}" required placeholder="Unit, Buah, m², dll"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('satuan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="pengguna" value="{{ old('pengguna') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('pengguna')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="status_aset" required class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="Digunakan" {{ old('status_aset') == 'Digunakan' ? 'selected' : '' }}>Digunakan</option>
                            <option value="Tidak Digunakan" {{ old('status_aset') == 'Tidak Digunakan' ? 'selected' : '' }}>Tidak Digunakan</option>
                            <option value="Dalam Perbaikan" {{ old('status_aset') == 'Dalam Perbaikan' ? 'selected' : '' }}>Dalam Perbaikan</option>
                            <option value="Disewakan" {{ old('status_aset') == 'Disewakan' ? 'selected' : '' }}>Disewakan</option>
                        </select>
                        @error('status_aset')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_dokumen_kepemilikan" value="{{ old('nomor_dokumen_kepemilikan') }}" placeholder="Untuk tanah/bangunan"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="luas" value="{{ old('luas') }}" min="0" step="0.01" placeholder="Untuk tanah/bangunan"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        @error('luas')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat_lengkap" rows="2" placeholder="Untuk tanah/bangunan"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('alamat_lengkap') }}</textarea>
