<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <div class="relative group">
                    <button id="exportBtn"
                        class="px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all duration-300 flex items-center space-x-2">
                    ...
                    <div
                        class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                ...
                <button onclick="printPage()"
                    class="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div
                class="bg-white rounded-2xl shadow-soft p-6 border border-gray-100 hover:shadow-hover transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <div
                        class="h-14 w-14 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-600 text-sm mt-1 flex items-center">
                            ...
                            @php
                                $percentage =
                                    $stats['total'] > 0 ? round(($stats['rp4'] / $stats['total']) * 100, 2) : 0;
                            @endphp
                            {{ $percentage }}% dari total
                        </p>
                    </div>
                    <div
                        class="h-14 w-14 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg shadow-green-500/20">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-purple-600 text-sm mt-1 flex items-center">
                            ...
                            @php
                                $percentage =
                                    $stats['total'] > 0 ? round(($stats['rkbmn'] / $stats['total']) * 100, 2) : 0;
                            @endphp
                            {{ $percentage }}% dari total
                        </p>
                    </div>
                    <div
                        class="h-14 w-14 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/20">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="h-14 w-14 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/20">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-2xl shadow-soft p-6 mb-6 border border-gray-100">
            ...
            <form method="GET" action="{{ route('manajemen-bmn.perencanaan.index') }}"
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div class="relative">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Jenis Dokumen</label>
                    <div class="relative">
                        <select name="jenis"
                            class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300 appearance-none">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        <select name="kategori"
                            ...
                            <option value="Penggunaan" {{ request('kategori') == 'Penggunaan' ? 'selected' : '' }}>
                                Penggunaan</option>
                            <option value="Pemanfaatan" {{ request('kategori') == 'Pemanfaatan' ? 'selected' : '' }}>
                                Pemanfaatan</option>
                            <option value="Pemindahtanganan"
                                {{ request('kategori') == 'Pemindahtanganan' ? 'selected' : '' }}>Pemindahtanganan
                            </option>
                ...
                <div class="flex items-end space-x-3">
                    <button type="submit"
                        class="flex-1 px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center space-x-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button type="button" id="advancedFilterToggle"
                        class="px-4 py-3.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div id="advancedFilterContent" class="hidden mt-6 pt-6 border-t border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="date" name="start_date" value="{{ request('start_date') }}"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="number" placeholder="Min" name="min_nilai"
                                value="{{ request('min_nilai') }}"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-blue-500">
                            <input type="number" placeholder="Max" name="max_nilai"
                                value="{{ request('max_nilai') }}"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-blue-500">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Pembuat</label>
                        <input type="text" placeholder="Nama pembuat" name="pembuat"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500">
                    @if ($perencanaans->total() > 0)
                        Menampilkan {{ $perencanaans->firstItem() }}-{{ $perencanaans->lastItem() }} dari
                        {{ $perencanaans->total() }} data
                    @else
                        Tidak ada data
                    @endif
                </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-all duration-200 group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div
                                            class="flex-shrink-0 h-10 w-10 rounded-lg bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center mr-3">
                                        ...
                                        <div>
                                            <div class="font-medium text-gray-900">{{ $perencanaan->nomor_dokumen }}
                                            </div>
                                            <div class="text-sm text-gray-500">
                                                {{ $perencanaan->created_at->format('d/m/Y') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="max-w-xs">
                                        <div class="font-medium text-gray-900 truncate">{{ $perencanaan->judul }}
                                        </div>
                                        <div class="text-sm text-gray-500 truncate">
                                            {{ Str::limit($perencanaan->deskripsi ?? '', 60) }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="h-9 w-9 rounded-lg bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center mr-2">
                                            <span
                                                class="font-bold text-gray-700">{{ $perencanaan->tahun_anggaran }}</span>
                                        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-semibold text-gray-900">Rp
                                        {{ number_format($perencanaan->nilai_estimasi ?? 0, 0, ',', '.') }}</div>
                                    @if ($perencanaan->volume)
                                        <div class="text-sm text-gray-500">{{ number_format($perencanaan->volume) }}
                                            {{ $perencanaan->satuan ?? '' }}</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        <div
                                            class="h-24 w-24 rounded-full bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center mb-4">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada data ditemukan
                                        </h3>
                                        <p class="text-gray-500 mb-4">Tidak ada dokumen perencanaan BMN yang sesuai
                                            dengan filter Anda</p>
                                        <button
                                            onclick="window.location.href='{{ route('manajemen-bmn.perencanaan.index') }}'"
                                            class="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300">
                                            Reset Filter
                                        </button>
                                    </div>
                                </td>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('exportBtn').addEventListener('click', function() {
                // Show export menu (already handled by CSS hover)
            });
